...
// export const http = new HttpService(process.env.VUE_APP_API_URL as string)

// Can contain multiple instances, eg. =>
export const httpService = {
  local: new HttpService(process.env.VUE_APP_API_URL as string),
  auth: new HttpService(process.env.VUE_APP_AUTH_URL as string),
  main: new HttpService(process.env.VUE_APP_BASE_URL as string)
}
